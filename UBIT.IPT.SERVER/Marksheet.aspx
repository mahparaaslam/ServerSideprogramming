<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Marksheet.aspx.cs" Inherits="UBIT.IPT.SERVER.Marksheet" %>
...
<script>
    ...
    function Calculate() {
        ...
        for (i = 0; i < noOfSubjects; i++) {
            ...
            var subjectMarksObtianed = $('#subjectMarksObtained' +i).val();


            var marks = new Object();

            marks.subjectName = subjectName;
            marks.subjectMarksObtianed = subjectMarksObtianed;
        ...
        $.ajax({
            ...
            type: "GET",
            url: "Marksheet.aspx/GetMarksSheet",
